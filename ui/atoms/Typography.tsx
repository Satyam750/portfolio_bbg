...
const typographyStyles = cva("[text-wrap:balance]", {
  variants: {
    variant: {
      p: "text-lg lg:text-3xl lg:leading-snug font-light -tracking-wide text-[#475460] text-balance",
      "p-sm": "text-2xl font-normal -tracking-wide leading-tight text-black",
      "p-xs": "text-base font-normal -tracking-wide text-[#475460]",
      ...
      h6: "text-[10px] lg:text-xs font-normal tracking-[2px] lg:tracking-[4px] text-[#475460]",
      link: "text-lg lg:text-2xl font-light -tracking-wide text-white underline hover:bg-lk-turquoise [&>svg]:hover:scale-[1.05] w-fit",
      small: "text-[#475460] text-lg lg:text-2xl font-normal",
    },
  },
});
